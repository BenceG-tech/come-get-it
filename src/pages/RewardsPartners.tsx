        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="azure-beam glass-effect rounded-xl p-6 text-center group hover:scale-105 transition-all duration-300">
                <div className="flex justify-center mb-4">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {valueProps.map((item, index) => (
              <div key={index} className="azure-beam glass-effect rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300">
                <div className="flex justify-center mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-electric-300/20 to-ocean-600/20 rounded-full flex items-center justify-center backdrop-blur-sm border border-electric-300/30">
